        ...
        <PopoverTrigger asChild>
          <button
            ...
            className={cn(
              ...
              'flex items-center gap-1 rounded-full border border-white/10 bg-black/40 px-1 py-1',
              'text-[9px] font-bold uppercase tracking-wide text-white/70 shadow-sm backdrop-blur-sm',
              'opacity-40 transition-all hover:border-amber-400/40 hover:bg-amber-500/10 hover:opacity-95'
            )}
          >
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-amber-500/15 text-xs leading-none text-amber-200/90">
              +
            </span>
            <span className="max-w-0 overflow-hidden whitespace-nowrap text-left text-[8px] font-bold leading-snug opacity-0 transition-all duration-200 group-hover:max-w-[11rem] group-hover:opacity-100">
              Add Sound Source
            </span>
          </button>
        </PopoverTrigger>
