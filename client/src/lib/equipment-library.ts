 ...
 * OPTIMIZED & COMPLETE - Includes 25+ Branded Units & 4 Detailed Consoles
 */
...
export interface EquipmentDef {
  ...
  accentColor: string;
  inputs: Array<{ id: string; label: string; type: 'mic' | 'line' | 'speaker' | 'digital'; position: number }>;
  outputs: Array<{ id: string; label: string; type: 'mic' | 'line' | 'speaker' | 'digital'; position: number }>;
  hasPhantom?: boolean;
  hasInsert?: boolean;
...
const genPorts = (count: number, prefix: string, type: 'mic' | 'line' | 'speaker' = 'line') => 
...
export const equipmentLibrary: EquipmentDef[] = [
  ...
  // --- MICROPHONES ---
  { id: 'shure-sm57', name: 'SM57 Dynamic', brand: 'Shure', model: 'SM57', category: 'microphone', description: 'Snare/Amp workhorse.', width: 40, heightUnits: 0, accentColor: '#333333', inputs: [], outputs: [{ id: 'xlr', label: 'XLR', type: 'mic', position: 0.9 }] },
  { id: 'shure-sm58', name: 'SM58 Dynamic', brand: 'Shure', model: 'SM58', category: 'microphone', description: 'Vocal standard.', width: 50, heightUnits: 0, accentColor: '#444444', inputs: [], outputs: [{ id: 'xlr', label: 'XLR', type: 'mic', position: 0.9 }] },
  { id: 'u87', name: 'U87 Condenser', brand: 'Neumann', model: 'U-87 Ai', category: 'microphone', description: 'Elite studio condenser.', width: 60, heightUnits: 0, accentColor: '#9ca3af', inputs: [], outputs: [{ id: 'xlr', label: 'XLR', type: 'mic', position: 0.9 }] },
  { id: 'akg-c414', name: 'C414 Condenser', brand: 'AKG', model: 'C-414 XLII', category: 'microphone', description: 'Versatile instrument mic.', width: 50, heightUnits: 0, accentColor: '#222222', inputs: [], outputs: [{ id: 'xlr', label: 'XLR', type: 'mic', position: 0.9 }] },
  { id: 'royer-r121', name: 'R-121 Ribbon', brand: 'Royer', model: 'R-121', category: 'microphone', description: 'Smooth ribbon mic.', width: 30, heightUnits: 0, accentColor: '#111111', inputs: [], outputs: [{ id: 'xlr', label: 'XLR', type: 'mic', position: 0.9 }] },

  // --- CONSOLES (OPTIMIZED CHANNEL DEFINITION) ---
  {
    id: 'vortex-1604',
