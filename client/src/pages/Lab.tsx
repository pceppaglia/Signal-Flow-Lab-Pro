...
export default function Lab() {
  ...
  // Mixer State (Keep your existing channel definitions)
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#050505] text-[#F5F0E8] overflow-hidden">
        ...
        <main className="flex-1 flex flex-col relative overflow-hidden bg-[radial-gradient(#111_1px,transparent_1px)] [background-size:32px_32px]">
          ...
          >
            <Canvas2DEquipmentRenderer
              ...
              onPortMouseDown={() => {}} // Connect logic here
              onPortMouseUp={() => {}}
              onViewChange={(x, y, z) => { ws.panView(x - ws.viewX, y - ws.viewY); }}
            />
        ...
        {ws.selectedNode && (
          <aside className="w-80 border-l border-[#222] bg-[#111] p-6 animate-in slide-in-from-right duration-200">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-sm font-bold tracking-widest text-[#E8A020]">DEVICE SETTINGS</h3>
      ...
      {/* FOOTER STATUS */}
      <footer className="h-6 bg-[#000] border-t border-[#222] flex items-center px-4 text-[9px] text-[#444] gap-6 uppercase tracking-widest">
        <span>Signal Flow: Active</span>
        <span>Sample Rate: 48kHz</span>
        <div className="flex-1" />
        <span>© 2024 RECORDINGSTUDIO.COM</span>
      </footer>
    </div>
  );
}